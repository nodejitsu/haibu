...
var MasterBridge = require('../bridge/master').MasterBridge;
...
exports.start = function (options, callback) {
  function startServer (err) {
    ...
    var bridge = haibu.running.bridge || (haibu.running.bridge = new MasterBridge(haibu));
    //bridge.listen(socket.getDomainServer(path.join(__dirname,'..','..','..','service')));
