...
//  console.log('push deploy server on:' + port)
exports.handler = function (drone, port) {
  /*
  ...
  */
  ...
  process.on('uncaughtException', function (err) {
    if(err) {
      ...
      console.error('FALSEY ERROR:', err)
  })
  ...
  //    console.error(req.method, deploy, user, appName)
